...
class CustomDatasetFromImages(Dataset):
    def __init__(self, transform, target_transform=identity, csv_path=configs.ISIC_path + "/ISIC2018_Task3_Training_GroundTruth/ISIC2018_Task3_Training_GroundTruth.csv", image_path=configs.ISIC_path + "/ISIC2018_Task3_Training_Input/", split=None):
        """
        Args:

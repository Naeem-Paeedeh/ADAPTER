...
do
  ...
  ###---------------------------------------------------------------------------------
    ...
    -i ${DIR_DS}/P2e-Epoch=$EPOCH -l ${DIR_LOGS}/Log-P2P3-Epoch=$EPOCH-1_shot-LGC=1,4-layers_MLP || exit 1
    ...
    -n_shots 5 \
    -n_epochs_training_classifier_head 150 \
    -i ${DIR_DS}/P2e-Epoch=$EPOCH -l ${DIR_LOGS}/Log-P2P3-Epoch=$EPOCH-5_shot-LGC=1,4-layers_MLP || exit 1
